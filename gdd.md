...
- Wands, 5%. Light, striking, lightning, fire, cold, magic missile, polymorph, haste monster, slow monster, drain life, teleport away, teleport to, cancellation, nothing. 3d3 damage on the offensive ones, 2d6+1 charges, and the range is per wand, 6 or 8.
...
What follows is a You die... panel, a --MORE--, and a tombstone with the name, the cause of death and the score. The score is the coins in the pack at the end, so anything hoarded and never turned into survival counts exactly as much as it sounds like it should.
